...
import me.proton.photos.data.api.dto.BaseResponse
...
import me.proton.photos.data.api.dto.CreateFileResponse
import me.proton.photos.data.api.dto.CreateRevisionResponse
import me.proton.photos.data.api.dto.DeleteLinksRequest
import me.proton.photos.data.api.dto.LinkDetailsResponse
import me.proton.photos.data.api.dto.PhotoLinksResponse
import me.proton.photos.data.api.dto.ShareDetailsResponse
import me.proton.photos.data.api.dto.SharesResponse
import me.proton.photos.data.api.dto.ThumbnailBatchRequest
import me.proton.photos.data.api.dto.ThumbnailBatchResponse
import me.proton.photos.data.api.dto.ThumbnailResponse
import me.proton.photos.data.api.dto.UploadBlockRequest
import me.proton.photos.data.api.dto.UploadBlockResponse
import me.proton.photos.data.api.dto.AlbumChildrenResponse
import me.proton.photos.data.api.dto.AlbumsResponse
import me.proton.photos.data.api.dto.BatchLinksRequest
import me.proton.photos.data.api.dto.BatchLinksResponse
import me.proton.photos.data.api.dto.AddAlbumMultipleRequest
import me.proton.photos.data.api.dto.CreateAlbumRequest
import me.proton.photos.data.api.dto.CreateAlbumResponse
import me.proton.photos.data.api.dto.CreatePhotoRequest
import me.proton.photos.data.api.dto.CreatePhotoResponse
import me.proton.photos.data.api.dto.CreatePhotosVolumeRequest
import me.proton.photos.data.api.dto.CreatePhotosVolumeResponse
import me.proton.photos.data.api.dto.PhotoTrashResponse
import me.proton.photos.data.api.dto.VolumeTrashResponse
import me.proton.photos.data.api.dto.PhotosShareResponse
import me.proton.photos.data.api.dto.CreateLinkShareResponse
import me.proton.photos.data.api.dto.CreateShareUrlRequest
import me.proton.photos.data.api.dto.CreateShareUrlResponse
import me.proton.photos.data.api.dto.ShareUrlsResponse
import me.proton.photos.data.api.dto.ShareInvitationRequest
import me.proton.photos.data.api.dto.FullLinkResponse
import me.proton.photos.data.api.dto.ShareInvitationsResponse
import me.proton.photos.data.api.dto.SharedWithMeResponse
import me.proton.photos.data.api.dto.GlobalInvitationsResponse
import me.proton.photos.data.api.dto.InvitationDetailResponse
import me.proton.photos.data.api.dto.ShareMembersResponse
import me.proton.photos.data.api.dto.DriveEventsResponse
import me.proton.photos.data.api.dto.EventAnchorResponse
import me.proton.photos.data.api.dto.RevisionListResponse
import me.proton.photos.data.api.dto.RevisionResponse
import me.proton.photos.data.api.dto.VerificationDataResponse
import me.proton.photos.data.api.dto.VolumesResponse
...
interface DriveApiService : BaseRetrofitApi {
    ...
    suspend fun removePhotosFromAlbum(
        @Path("volumeId") volumeId: String,
        @Path("albumLinkId") albumLinkId: String,
        @Body request: me.proton.photos.data.api.dto.RemoveFromAlbumRequest,
    ): BaseResponse
    ...
    suspend fun updateAlbum(
        @Path("volumeId") volumeId: String,
        @Path("albumLinkId") albumLinkId: String,
        @Body request: me.proton.photos.data.api.dto.UpdateAlbumRequest,
    ): BaseResponse
    ...
    suspend fun addFavorite(
        ...
        @Body request: me.proton.photos.data.api.dto.FavoriteRequest,
    ): BaseResponse
    ...
    suspend fun addPhotoTags(
        @Path("volumeId") volumeId: String,
        @Path("linkId") linkId: String,
        @Body request: me.proton.photos.data.api.dto.TagRequest,
    ): BaseResponse
    ...
    suspend fun fetchLinkMetadata(
        @Path("shareId") shareId: String,
        @Body request: BatchLinksRequest,
    ): me.proton.photos.data.api.dto.FetchLinksResponse
    ...
    suspend fun createVolumeShare(
        @Path("volumeId") volumeId: String,
        @Body request: me.proton.photos.data.api.dto.CreateShareRequest,
    ): me.proton.photos.data.api.dto.CreateShareResponse
    ...
    suspend fun inviteToShare(
        @Path("shareId") shareId: String,
        @Body request: me.proton.photos.data.api.dto.CreateInvitationRequest,
    ): BaseResponse
    ...
    suspend fun acceptInvitation(
        @Path("invitationId") invitationId: String,
        @Body request: me.proton.photos.data.api.dto.AcceptInvitationRequest,
    ): BaseResponse
